...
function App() {
  ...
  const loadHistoryRange = useCallback(({ range, endDate }) => import('./utils/storage').then(({ getCompleteHistoryRange }) => getCompleteHistoryRange(user?.uid, { range, endDate })), [user?.uid])
