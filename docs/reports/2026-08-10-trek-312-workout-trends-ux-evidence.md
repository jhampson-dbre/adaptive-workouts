...
| Weighted evidence | 390 x 844 | Bench Press defaults to 3M and shows `Workout volume (lb)` across the complete May 10–August 10 window, three irregular real workout dates, rounded 2000–3500 lb grid labels, an explicit selected-workout date, latest/range-high/previous-session/session-count facts, and confirmed sets. Home selects May 27 (2280 lb); ArrowRight selects July 7 (2700 lb) while focus stays on the native scrubber. |
